...
namespace ECommerce.API.Migrations
{
    ...
    [Migration("20260923152145_UpdateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.API.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.API.Models.Message", b =>
                {
                    b.HasOne("ECommerce.API.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.API.Models.User", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.API.Models.Transaction", b =>
                {
                    b.HasOne("ECommerce.API.Models.Order", "Order")
                        .WithOne("Transaction")
                        .HasForeignKey("ECommerce.API.Models.Transaction", "OrderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
